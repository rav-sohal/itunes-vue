            ...
            <div class="col-md-3" v-for="(result, index) in itemList" :key="index">
                <div class="card playlist-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button class="btn btn-danger btn-sm btn-block" v-on:click="removeElement(index)">Remove</button>

                            </div>

                            <div class="col-md-6">
                                <button class="btn btn-secondary btn-sm btn-block" @click="toiTunesAlbum(result)">View</button>
