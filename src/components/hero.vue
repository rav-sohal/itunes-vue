                        ...
                        <form>
                            <div class="form-row">
                                <div class="form-group col-md-9 mb-2">
                                    ...
                                    <input class="form-control form-control-lg mb-3" type="search" placeholder="Search" aria-label="Search" v-model="search" required autocomplete="off" id="search" />
                                </div>
                                <div class="form-group col-md-3 mb-2">
                                    <button class="btn btn-info btn-lg btn-block mb-3" type="submit" v-on:click="getData">
                        ...
                        <div class="result-div">
                            <div v-for="(result, index) in paginated" :key="index">
                                <div class="media mb-4">
                                    <img :src="resizeArtworkUrl(result)" alt="Album Cover" class="album-cover align-self-start mr-3" />
                ...
                <font-awesome-icon icon="plus"/>
                    ...
                    <b>{{result.collectionName}}</b>
                            ...
                            <div class="paginated-btns mb-3 mt-3" v-if="result.length > 1 ">
                                <button class="btn btn-secondary btn-lg mr-3 pag-btn" :disabled="page === 0" @click="prevPage">Previous</button>
                                <button class="btn btn-secondary btn-lg pag-btn" :disabled="page >= pageCount - 1" @click="nextPage">Next</button>
                            </div>
